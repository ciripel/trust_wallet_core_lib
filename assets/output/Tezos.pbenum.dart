...
class Operation_OperationKind extends $pb.ProtobufEnum {
  static const Operation_OperationKind ENDORSEMENT = Operation_OperationKind._(
      0,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'ENDORSEMENT');
  static const Operation_OperationKind REVEAL = Operation_OperationKind._(
      107,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'REVEAL');
  static const Operation_OperationKind TRANSACTION = Operation_OperationKind._(
      108,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'TRANSACTION');
  static const Operation_OperationKind DELEGATION = Operation_OperationKind._(
      110,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'DELEGATION');
