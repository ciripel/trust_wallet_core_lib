...
final $typed_data.Uint8List signingInputDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List signingOutputDescriptor = $convert.base64Decode(
    'Cg1TaWduaW5nT3V0cHV0EhgKB2VuY29kZWQYASABKAxSB2VuY29kZWQSDAoBdhgCIAEoDFIBdhIMCgFyGAMgASgMUgFyEgwKAXMYBCABKAxSAXM=');
...
final $typed_data.Uint8List transactionMessageDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List stakingMessageDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List descriptionDescriptor = $convert.base64Decode(
    'CgtEZXNjcmlwdGlvbhISCgRuYW1lGAEgASgJUgRuYW1lEhoKCGlkZW50aXR5GAIgASgJUghpZGVudGl0eRIYCgd3ZWJzaXRlGAMgASgJUgd3ZWJzaXRlEikKEHNlY3VyaXR5X2NvbnRhY3QYBCABKAlSD3NlY3VyaXR5Q29udGFjdBIYCgdkZXRhaWxzGAUgASgJUgdkZXRhaWxz');
...
final $typed_data.Uint8List decimalDescriptor = $convert.base64Decode(
    'CgdEZWNpbWFsEhQKBXZhbHVlGAEgASgMUgV2YWx1ZRIcCglwcmVjaXNpb24YAiABKAxSCXByZWNpc2lvbg==');
...
final $typed_data.Uint8List commissionRateDescriptor = $convert.base64Decode(
    'Cg5Db21taXNzaW9uUmF0ZRItCgRyYXRlGAEgASgLMhkuVFcuSGFybW9ueS5Qcm90by5EZWNpbWFsUgRyYXRlEjQKCG1heF9yYXRlGAIgASgLMhkuVFcuSGFybW9ueS5Qcm90by5EZWNpbWFsUgdtYXhSYXRlEkEKD21heF9jaGFuZ2VfcmF0ZRgDIAEoCzIZLlRXLkhhcm1vbnkuUHJvdG8uRGVjaW1hbFINbWF4Q2hhbmdlUmF0ZQ==');
...
final $typed_data.Uint8List directiveCreateValidatorDescriptor =
    $convert.base64Decode(
        '');
...
final $typed_data.Uint8List directiveEditValidatorDescriptor =
    $convert.base64Decode(
        '');
...
final $typed_data.Uint8List directiveDelegateDescriptor = $convert.base64Decode(
    'ChFEaXJlY3RpdmVEZWxlZ2F0ZRIrChFkZWxlZ2F0b3JfYWRkcmVzcxgBIAEoCVIQZGVsZWdhdG9yQWRkcmVzcxIrChF2YWxpZGF0b3JfYWRkcmVzcxgCIAEoCVIQdmFsaWRhdG9yQWRkcmVzcxIWCgZhbW91bnQYAyABKAxSBmFtb3VudA==');
...
final $typed_data.Uint8List directiveUndelegateDescriptor = $convert.base64Decode(
    'ChNEaXJlY3RpdmVVbmRlbGVnYXRlEisKEWRlbGVnYXRvcl9hZGRyZXNzGAEgASgJUhBkZWxlZ2F0b3JBZGRyZXNzEisKEXZhbGlkYXRvcl9hZGRyZXNzGAIgASgJUhB2YWxpZGF0b3JBZGRyZXNzEhYKBmFtb3VudBgDIAEoDFIGYW1vdW50');
...
final $typed_data.Uint8List directiveCollectRewardsDescriptor =
    $convert.base64Decode(
        'ChdEaXJlY3RpdmVDb2xsZWN0UmV3YXJkcxIrChFkZWxlZ2F0b3JfYWRkcmVzcxgBIAEoCVIQZGVsZWdhdG9yQWRkcmVzcw==');
