...
class Staking_Create extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOS(
        ...
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'candidateName',
        protoName: 'candidateName')
    ..aOS(
        2,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'stakedAmount',
        protoName: 'stakedAmount')
    ..a<$core.int>(
        3,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
  ...
  Staking_Create copyWith(void Function(Staking_Create) updates) =>
      super.copyWith((message) => updates(message as Staking_Create))
          as Staking_Create; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class Staking_Reclaim extends $pb.GeneratedMessage {
  ...
  Staking_Reclaim copyWith(void Function(Staking_Reclaim) updates) =>
      super.copyWith((message) => updates(message as Staking_Reclaim))
          as Staking_Reclaim; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class Staking_AddDeposit extends $pb.GeneratedMessage {
  ...
  Staking_AddDeposit copyWith(void Function(Staking_AddDeposit) updates) =>
      super.copyWith((message) => updates(message as Staking_AddDeposit))
          as Staking_AddDeposit; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class Staking_Restake extends $pb.GeneratedMessage {
  ...
  Staking_Restake copyWith(void Function(Staking_Restake) updates) =>
      super.copyWith((message) => updates(message as Staking_Restake))
          as Staking_Restake; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class Staking_ChangeCandidate extends $pb.GeneratedMessage {
  ...
  Staking_ChangeCandidate copyWith(
      ...
      super.copyWith((message) => updates(message as Staking_ChangeCandidate))
          as Staking_ChangeCandidate; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class Staking_TransferOwnership extends $pb.GeneratedMessage {
  ...
  Staking_TransferOwnership copyWith(
      ...
      super.copyWith((message) => updates(message as Staking_TransferOwnership))
          as Staking_TransferOwnership; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class Staking_CandidateBasicInfo extends $pb.GeneratedMessage {
  ...
  Staking_CandidateBasicInfo copyWith(
      ...
      super.copyWith(
          ...
          as Staking_CandidateBasicInfo; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class Staking_CandidateRegister extends $pb.GeneratedMessage {
  ...
  Staking_CandidateRegister copyWith(
      ...
      super.copyWith((message) => updates(message as Staking_CandidateRegister))
          as Staking_CandidateRegister; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<Staking_Create>(
        ...
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'stakeCreate',
        protoName: 'stakeCreate',
        subBuilder: Staking_Create.create)
    ..aOM<Staking_Reclaim>(
        2,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'stakeUnstake',
        protoName: 'stakeUnstake',
        subBuilder: Staking_Reclaim.create)
    ..aOM<Staking_Reclaim>(
        3,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'stakeWithdraw',
        protoName: 'stakeWithdraw',
        subBuilder: Staking_Reclaim.create)
    ..aOM<Staking_AddDeposit>(
        4,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'stakeAddDeposit',
        protoName: 'stakeAddDeposit',
        subBuilder: Staking_AddDeposit.create)
    ..aOM<Staking_Restake>(
        5,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'stakeRestake',
        protoName: 'stakeRestake',
        subBuilder: Staking_Restake.create)
...
class ContractCall extends $pb.GeneratedMessage {
  ...
  ContractCall copyWith(void Function(ContractCall) updates) =>
      super.copyWith((message) => updates(message as ContractCall))
          as ContractCall; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class ActionCore extends $pb.GeneratedMessage {
  ...
  ActionCore copyWith(void Function(ActionCore) updates) =>
      super.copyWith((message) => updates(message as ActionCore))
          as ActionCore; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
