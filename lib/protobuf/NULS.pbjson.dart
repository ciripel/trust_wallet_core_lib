...
final $typed_data.Uint8List transactionCoinFromDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List transactionCoinToDescriptor = $convert.base64Decode(
    'ChFUcmFuc2FjdGlvbkNvaW5UbxIdCgp0b19hZGRyZXNzGAEgASgJUgl0b0FkZHJlc3MSJQoOYXNzZXRzX2NoYWluaWQYAiABKA1SDWFzc2V0c0NoYWluaWQSGwoJYXNzZXRzX2lkGAMgASgNUghhc3NldHNJZBIbCglpZF9hbW91bnQYBCABKAxSCGlkQW1vdW50EhsKCWxvY2tfdGltZRgFIAEoDVIIbG9ja1RpbWU=');
...
final $typed_data.Uint8List signatureDescriptor = $convert.base64Decode(
    'CglTaWduYXR1cmUSGQoIcGtleV9sZW4YASABKA1SB3BrZXlMZW4SHQoKcHVibGljX2tleRgCIAEoDFIJcHVibGljS2V5EhcKB3NpZ19sZW4YAyABKA1SBnNpZ0xlbhIcCglzaWduYXR1cmUYBCABKAxSCXNpZ25hdHVyZQ==');
...
final $typed_data.Uint8List transactionDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List signingInputDescriptor = $convert.base64Decode(
    '');
