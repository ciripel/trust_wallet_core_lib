...
enum Transaction_MessageOneof { transfer, rawTransaction, notSet }

class Transaction extends $pb.GeneratedMessage {
  static const $core.Map<$core.int, Transaction_MessageOneof>
      _Transaction_MessageOneofByTag = {
  ...
  Transaction_MessageOneof whichMessageOneof() =>
      _Transaction_MessageOneofByTag[$_whichOneof(0)]!;
  ...
  @$pb.TagNumber(2)
  set rawTransaction(Transaction_Raw v) {
    setField(2, v);
  }
