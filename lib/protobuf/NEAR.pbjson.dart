...
final $typed_data.Uint8List publicKeyDescriptor = $convert.base64Decode(
    'CglQdWJsaWNLZXkSGQoIa2V5X3R5cGUYASABKA1SB2tleVR5cGUSEgoEZGF0YRgCIAEoDFIEZGF0YQ==');
...
final $typed_data.Uint8List accessKeyDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List functionCallDescriptor = $convert.base64Decode(
    'CgxGdW5jdGlvbkNhbGwSHwoLbWV0aG9kX25hbWUYASABKAlSCm1ldGhvZE5hbWUSEgoEYXJncxgCIAEoDFIEYXJncxIQCgNnYXMYAyABKARSA2dhcxIYCgdkZXBvc2l0GAQgASgMUgdkZXBvc2l0');
...
final $typed_data.Uint8List addKeyDescriptor = $convert.base64Decode(
    'CgZBZGRLZXkSNwoKcHVibGljX2tleRgBIAEoCzIYLlRXLk5FQVIuUHJvdG8uUHVibGljS2V5UglwdWJsaWNLZXkSNwoKYWNjZXNzX2tleRgCIAEoCzIYLlRXLk5FQVIuUHJvdG8uQWNjZXNzS2V5UglhY2Nlc3NLZXk=');
...
final $typed_data.Uint8List deleteKeyDescriptor = $convert.base64Decode(
    'CglEZWxldGVLZXkSNwoKcHVibGljX2tleRgBIAEoCzIYLlRXLk5FQVIuUHJvdG8uUHVibGljS2V5UglwdWJsaWNLZXk=');
...
final $typed_data.Uint8List actionDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List signingInputDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List signingOutputDescriptor = $convert.base64Decode(
    'Cg1TaWduaW5nT3V0cHV0Ei0KEnNpZ25lZF90cmFuc2FjdGlvbhgBIAEoDFIRc2lnbmVkVHJhbnNhY3Rpb24SEgoEaGFzaBgCIAEoDFIEaGFzaA==');
