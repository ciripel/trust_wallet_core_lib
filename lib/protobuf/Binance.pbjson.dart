...
final $typed_data.Uint8List transactionDescriptor = $convert.base64Decode(
    'CgtUcmFuc2FjdGlvbhISCgRtc2dzGAEgAygMUgRtc2dzEh4KCnNpZ25hdHVyZXMYAiADKAxSCnNpZ25hdHVyZXMSEgoEbWVtbxgDIAEoCVIEbWVtbxIWCgZzb3VyY2UYBCABKANSBnNvdXJjZRISCgRkYXRhGAUgASgMUgRkYXRh');
...
final $typed_data.Uint8List signatureDescriptor = $convert.base64Decode(
    'CglTaWduYXR1cmUSFwoHcHViX2tleRgBIAEoDFIGcHViS2V5EhwKCXNpZ25hdHVyZRgCIAEoDFIJc2lnbmF0dXJlEiUKDmFjY291bnRfbnVtYmVyGAMgASgDUg1hY2NvdW50TnVtYmVyEhoKCHNlcXVlbmNlGAQgASgDUghzZXF1ZW5jZRoICgZQdWJLZXk=');
...
final $typed_data.Uint8List tradeOrderDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List cancelTradeOrderDescriptor = $convert.base64Decode(
    'ChBDYW5jZWxUcmFkZU9yZGVyEhYKBnNlbmRlchgBIAEoDFIGc2VuZGVyEhYKBnN5bWJvbBgCIAEoCVIGc3ltYm9sEhQKBXJlZmlkGAMgASgJUgVyZWZpZA==');
...
const SendOrder$json = const {
  ...
  '3': const [
    SendOrder_Token$json,
    SendOrder_Input$json,
    SendOrder_Output$json
  ],
};
...
final $typed_data.Uint8List sendOrderDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List tokenIssueOrderDescriptor = $convert.base64Decode(
    'Cg9Ub2tlbklzc3VlT3JkZXISEgoEZnJvbRgBIAEoDFIEZnJvbRISCgRuYW1lGAIgASgJUgRuYW1lEhYKBnN5bWJvbBgDIAEoCVIGc3ltYm9sEiEKDHRvdGFsX3N1cHBseRgEIAEoA1ILdG90YWxTdXBwbHkSGgoIbWludGFibGUYBSABKAhSCG1pbnRhYmxl');
...
final $typed_data.Uint8List tokenMintOrderDescriptor = $convert.base64Decode(
    'Cg5Ub2tlbk1pbnRPcmRlchISCgRmcm9tGAEgASgMUgRmcm9tEhYKBnN5bWJvbBgCIAEoCVIGc3ltYm9sEhYKBmFtb3VudBgDIAEoA1IGYW1vdW50');
...
final $typed_data.Uint8List tokenBurnOrderDescriptor = $convert.base64Decode(
    'Cg5Ub2tlbkJ1cm5PcmRlchISCgRmcm9tGAEgASgMUgRmcm9tEhYKBnN5bWJvbBgCIAEoCVIGc3ltYm9sEhYKBmFtb3VudBgDIAEoA1IGYW1vdW50');
...
final $typed_data.Uint8List tokenFreezeOrderDescriptor = $convert.base64Decode(
    'ChBUb2tlbkZyZWV6ZU9yZGVyEhIKBGZyb20YASABKAxSBGZyb20SFgoGc3ltYm9sGAIgASgJUgZzeW1ib2wSFgoGYW1vdW50GAMgASgDUgZhbW91bnQ=');
...
final $typed_data.Uint8List tokenUnfreezeOrderDescriptor = $convert.base64Decode(
    'ChJUb2tlblVuZnJlZXplT3JkZXISEgoEZnJvbRgBIAEoDFIEZnJvbRIWCgZzeW1ib2wYAiABKAlSBnN5bWJvbBIWCgZhbW91bnQYAyABKANSBmFtb3VudA==');
...
final $typed_data.Uint8List hTLTOrderDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List depositHTLTOrderDescriptor = $convert.base64Decode(
    'ChBEZXBvc2l0SFRMVE9yZGVyEhIKBGZyb20YASABKAxSBGZyb20SOQoGYW1vdW50GAIgAygLMiEuVFcuQmluYW5jZS5Qcm90by5TZW5kT3JkZXIuVG9rZW5SBmFtb3VudBIXCgdzd2FwX2lkGAMgASgMUgZzd2FwSWQ=');
...
final $typed_data.Uint8List claimHTLOrderDescriptor = $convert.base64Decode(
    'Cg1DbGFpbUhUTE9yZGVyEhIKBGZyb20YASABKAxSBGZyb20SFwoHc3dhcF9pZBgCIAEoDFIGc3dhcElkEiMKDXJhbmRvbV9udW1iZXIYAyABKAxSDHJhbmRvbU51bWJlcg==');
...
final $typed_data.Uint8List refundHTLTOrderDescriptor = $convert.base64Decode(
    'Cg9SZWZ1bmRIVExUT3JkZXISEgoEZnJvbRgBIAEoDFIEZnJvbRIXCgdzd2FwX2lkGAIgASgMUgZzd2FwSWQ=');
...
final $typed_data.Uint8List transferOutDescriptor = $convert.base64Decode(
    'CgtUcmFuc2Zlck91dBISCgRmcm9tGAEgASgMUgRmcm9tEg4KAnRvGAIgASgMUgJ0bxI5CgZhbW91bnQYAyABKAsyIS5UVy5CaW5hbmNlLlByb3RvLlNlbmRPcmRlci5Ub2tlblIGYW1vdW50Eh8KC2V4cGlyZV90aW1lGAQgASgDUgpleHBpcmVUaW1l');
...
final $typed_data.Uint8List sideChainDelegateDescriptor = $convert.base64Decode(
    'ChFTaWRlQ2hhaW5EZWxlZ2F0ZRIlCg5kZWxlZ2F0b3JfYWRkchgBIAEoDFINZGVsZWdhdG9yQWRkchIlCg52YWxpZGF0b3JfYWRkchgCIAEoDFINdmFsaWRhdG9yQWRkchJBCgpkZWxlZ2F0aW9uGAMgASgLMiEuVFcuQmluYW5jZS5Qcm90by5TZW5kT3JkZXIuVG9rZW5SCmRlbGVnYXRpb24SGQoIY2hhaW5faWQYBCABKAlSB2NoYWluSWQ=');
...
final $typed_data.Uint8List sideChainRedelegateDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List sideChainUndelegateDescriptor = $convert.base64Decode(
    'ChNTaWRlQ2hhaW5VbmRlbGVnYXRlEiUKDmRlbGVnYXRvcl9hZGRyGAEgASgMUg1kZWxlZ2F0b3JBZGRyEiUKDnZhbGlkYXRvcl9hZGRyGAIgASgMUg12YWxpZGF0b3JBZGRyEjkKBmFtb3VudBgDIAEoCzIhLlRXLkJpbmFuY2UuUHJvdG8uU2VuZE9yZGVyLlRva2VuUgZhbW91bnQSGQoIY2hhaW5faWQYBCABKAlSB2NoYWluSWQ=');
...
final $typed_data.Uint8List timeLockOrderDescriptor = $convert.base64Decode(
    'Cg1UaW1lTG9ja09yZGVyEiEKDGZyb21fYWRkcmVzcxgBIAEoDFILZnJvbUFkZHJlc3MSIAoLZGVzY3JpcHRpb24YAiABKAlSC2Rlc2NyaXB0aW9uEjkKBmFtb3VudBgDIAMoCzIhLlRXLkJpbmFuY2UuUHJvdG8uU2VuZE9yZGVyLlRva2VuUgZhbW91bnQSGwoJbG9ja190aW1lGAQgASgDUghsb2NrVGltZQ==');
...
final $typed_data.Uint8List timeRelockOrderDescriptor = $convert.base64Decode(
    'Cg9UaW1lUmVsb2NrT3JkZXISIQoMZnJvbV9hZGRyZXNzGAEgASgMUgtmcm9tQWRkcmVzcxIOCgJpZBgCIAEoA1ICaWQSIAoLZGVzY3JpcHRpb24YAyABKAlSC2Rlc2NyaXB0aW9uEjkKBmFtb3VudBgEIAMoCzIhLlRXLkJpbmFuY2UuUHJvdG8uU2VuZE9yZGVyLlRva2VuUgZhbW91bnQSGwoJbG9ja190aW1lGAUgASgDUghsb2NrVGltZQ==');
...
final $typed_data.Uint8List timeUnlockOrderDescriptor = $convert.base64Decode(
    'Cg9UaW1lVW5sb2NrT3JkZXISIQoMZnJvbV9hZGRyZXNzGAEgASgMUgtmcm9tQWRkcmVzcxIOCgJpZBgCIAEoA1ICaWQ=');
...
final $typed_data.Uint8List signingInputDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List signingOutputDescriptor = $convert.base64Decode(
    'Cg1TaWduaW5nT3V0cHV0EhgKB2VuY29kZWQYASABKAxSB2VuY29kZWQSMwoFZXJyb3IYAiABKA4yHS5UVy5Db21tb24uUHJvdG8uU2lnbmluZ0Vycm9yUgVlcnJvchIjCg1lcnJvcl9tZXNzYWdlGAMgASgJUgxlcnJvck1lc3NhZ2U=');
