...
class TransactionCoinFrom extends $pb.GeneratedMessage {
  ...
  TransactionCoinFrom copyWith(void Function(TransactionCoinFrom) updates) =>
      super.copyWith((message) => updates(message as TransactionCoinFrom))
          as TransactionCoinFrom; // ignore: deprecated_member_use
  ...
  @$pb.TagNumber(4)
  set idAmount($core.List<$core.int> v) {
    $_setBytes(3, v);
  }
...
class TransactionCoinTo extends $pb.GeneratedMessage {
  ...
  TransactionCoinTo copyWith(void Function(TransactionCoinTo) updates) =>
      super.copyWith((message) => updates(message as TransactionCoinTo))
          as TransactionCoinTo; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class Transaction extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..a<$core.List<$core.int>>(
        ...
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ...
            : 'txData',
        $pb.PbFieldType.OY)
    ..aOM<TransactionCoinFrom>(
        5,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'input',
        subBuilder: TransactionCoinFrom.create)
    ..aOM<TransactionCoinTo>(
        6,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'output',
  ...
  @$pb.TagNumber(4)
  set txData($core.List<$core.int> v) {
    $_setBytes(3, v);
  }
  ...
  @$pb.TagNumber(6)
  set output(TransactionCoinTo v) {
    setField(6, v);
  }
...
class SigningInput extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(9)
  set balance($core.List<$core.int> v) {
    $_setBytes(8, v);
  }
