...
class Era extends $pb.GeneratedMessage {
  ...
  factory Era.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory Era.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      ...
      'Will be removed in next major version')
  Era copyWith(void Function(Era) updates) =>
      super.copyWith((message) => updates(message as Era))
          as Era; // ignore: deprecated_member_use
  ...
  @$core.pragma('dart2js:noInline')
  static Era getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<Era>(create);
...
class Balance_Transfer extends $pb.GeneratedMessage {
  ...
  Balance_Transfer copyWith(void Function(Balance_Transfer) updates) =>
      super.copyWith((message) => updates(message as Balance_Transfer))
          as Balance_Transfer; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class Staking_Bond extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..e<RewardDestination>(
        ...
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ...
            : 'rewardDestination',
        $pb.PbFieldType.OE,
        defaultOrMaker: RewardDestination.STAKED,
        valueOf: RewardDestination.valueOf,
  ...
  Staking_Bond copyWith(void Function(Staking_Bond) updates) =>
      super.copyWith((message) => updates(message as Staking_Bond))
          as Staking_Bond; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(3)
  set rewardDestination(RewardDestination v) {
    setField(3, v);
  }
...
class Staking_BondAndNominate extends $pb.GeneratedMessage {
  ...
  factory Staking_BondAndNominate.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory Staking_BondAndNominate.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
      'Will be removed in next major version')
  Staking_BondAndNominate clone() =>
      Staking_BondAndNominate()..mergeFromMessage(this);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  Staking_BondAndNominate copyWith(
          void Function(Staking_BondAndNominate) updates) =>
      super.copyWith((message) => updates(message as Staking_BondAndNominate))
          as Staking_BondAndNominate; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static Staking_BondAndNominate create() => Staking_BondAndNominate._();
  Staking_BondAndNominate createEmptyInstance() => create();
  static $pb.PbList<Staking_BondAndNominate> createRepeated() =>
      $pb.PbList<Staking_BondAndNominate>();
  @$core.pragma('dart2js:noInline')
  static Staking_BondAndNominate getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<Staking_BondAndNominate>(create);
...
class Staking_BondExtra extends $pb.GeneratedMessage {
  ...
  Staking_BondExtra copyWith(void Function(Staking_BondExtra) updates) =>
      super.copyWith((message) => updates(message as Staking_BondExtra))
          as Staking_BondExtra; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class Staking_Unbond extends $pb.GeneratedMessage {
  ...
  Staking_Unbond copyWith(void Function(Staking_Unbond) updates) =>
      super.copyWith((message) => updates(message as Staking_Unbond))
          as Staking_Unbond; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class Staking_WithdrawUnbonded extends $pb.GeneratedMessage {
  ...
  Staking_WithdrawUnbonded copyWith(
      ...
      super.copyWith((message) => updates(message as Staking_WithdrawUnbonded))
          as Staking_WithdrawUnbonded; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class Staking_Nominate extends $pb.GeneratedMessage {
  ...
  Staking_Nominate copyWith(void Function(Staking_Nominate) updates) =>
      super.copyWith((message) => updates(message as Staking_Nominate))
          as Staking_Nominate; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class Staking_ChillAndUnbond extends $pb.GeneratedMessage {
  ...
  factory Staking_ChillAndUnbond.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory Staking_ChillAndUnbond.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
      'Will be removed in next major version')
  Staking_ChillAndUnbond clone() =>
      Staking_ChillAndUnbond()..mergeFromMessage(this);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  Staking_ChillAndUnbond copyWith(
          void Function(Staking_ChillAndUnbond) updates) =>
      super.copyWith((message) => updates(message as Staking_ChillAndUnbond))
          as Staking_ChillAndUnbond; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static Staking_ChillAndUnbond create() => Staking_ChillAndUnbond._();
  Staking_ChillAndUnbond createEmptyInstance() => create();
  static $pb.PbList<Staking_ChillAndUnbond> createRepeated() =>
      $pb.PbList<Staking_ChillAndUnbond>();
  @$core.pragma('dart2js:noInline')
  static Staking_ChillAndUnbond getDefault() => _defaultInstance ??=
...
class Staking_Chill extends $pb.GeneratedMessage {
  ...
  Staking_Chill copyWith(void Function(Staking_Chill) updates) =>
      super.copyWith((message) => updates(message as Staking_Chill))
          as Staking_Chill; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class Staking extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<Staking_BondAndNominate>(
        2,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'bondAndNominate',
        subBuilder: Staking_BondAndNominate.create)
    ..aOM<Staking_BondExtra>(
        3,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'bondExtra',
  ...
  Staking copyWith(void Function(Staking) updates) =>
      super.copyWith((message) => updates(message as Staking))
          as Staking; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(2)
  set bondAndNominate(Staking_BondAndNominate v) {
    setField(2, v);
  }
  ...
  @$pb.TagNumber(8)
  set chillAndUnbond(Staking_ChillAndUnbond v) {
    setField(8, v);
  }
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..e<Network>(
        ...
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ...
            : 'network',
        $pb.PbFieldType.OE,
        defaultOrMaker: Network.POLKADOT,
