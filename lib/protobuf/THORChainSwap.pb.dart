...
class SwapInput extends $pb.GeneratedMessage {
  ...
  SwapInput copyWith(void Function(SwapInput) updates) =>
      super.copyWith((message) => updates(message as SwapInput))
          as SwapInput; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(5)
  set vaultAddress($core.String v) {
    $_setString(4, v);
  }
  ...
  @$pb.TagNumber(6)
  set routerAddress($core.String v) {
    $_setString(5, v);
  }
...
enum SwapOutput_SigningInputOneof { bitcoin, ethereum, binance, notSet }
...
class SwapOutput extends $pb.GeneratedMessage {
  ...
  SwapOutput copyWith(void Function(SwapOutput) updates) =>
      super.copyWith((message) => updates(message as SwapOutput))
          as SwapOutput; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
