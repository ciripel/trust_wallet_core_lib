...
abstract class TWNervosAddress {
  ...
  static late final _TWNervosAddressEqual_ptr =
      _lookup<NativeFunction<_c_TWNervosAddressEqual>>('TWNervosAddressEqual');
  static late final _dart_TWNervosAddressEqual _TWNervosAddressEqual =
  ...
  static late final _TWNervosAddressIsValidString_ptr =
      _lookup<NativeFunction<_c_TWNervosAddressIsValidString>>(
          'TWNervosAddressIsValidString');
  static late final _dart_TWNervosAddressIsValidString
  ...
  static late final _TWNervosAddressCreateWithString_ptr =
      _lookup<NativeFunction<_c_TWNervosAddressCreateWithString>>(
          'TWNervosAddressCreateWithString');
  static late final _dart_TWNervosAddressCreateWithString
  ...
  late final _TWNervosAddressDelete_ptr =
      _lookup<NativeFunction<_c_TWNervosAddressDelete>>(
  ...
  late final _TWNervosAddressDescription_ptr =
      _lookup<NativeFunction<_c_TWNervosAddressDescription>>(
  ...
  late final _TWNervosAddressCodeHash_ptr =
      _lookup<NativeFunction<_c_TWNervosAddressCodeHash>>(
  ...
  late final _TWNervosAddressHashType_ptr =
      _lookup<NativeFunction<_c_TWNervosAddressHashType>>(
  ...
  late final _TWNervosAddressArgs_ptr =
      _lookup<NativeFunction<_c_TWNervosAddressArgs>>('TWNervosAddressArgs');
