...
abstract class TWAnySigner {
  ...
  static late final _TWAnySignerSign_ptr =
      _lookup<NativeFunction<_c_TWAnySignerSign>>('TWAnySignerSign');
  static late final _dart_TWAnySignerSign _TWAnySignerSign =
  ...
  static late final _TWAnySignerSignJSON_ptr =
      _lookup<NativeFunction<_c_TWAnySignerSignJSON>>('TWAnySignerSignJSON');
  static late final _dart_TWAnySignerSignJSON _TWAnySignerSignJSON =
  ...
  static late final _TWAnySignerSupportsJSON_ptr =
      _lookup<NativeFunction<_c_TWAnySignerSupportsJSON>>(
          'TWAnySignerSupportsJSON');
  static late final _dart_TWAnySignerSupportsJSON _TWAnySignerSupportsJSON =
  ...
  static late final _TWAnySignerPlan_ptr =
      _lookup<NativeFunction<_c_TWAnySignerPlan>>('TWAnySignerPlan');
  static late final _dart_TWAnySignerPlan _TWAnySignerPlan =
