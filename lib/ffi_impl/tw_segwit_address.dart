...
abstract class TWSegwitAddress {
  ...
  static late final _TWSegwitAddressEqual_ptr =
      _lookup<NativeFunction<_c_TWSegwitAddressEqual>>('TWSegwitAddressEqual');
  ...
  static late final _dart_TWSegwitAddressIsValidString
  ...
  static late final _TWSegwitAddressCreateWithString_ptr =
      _lookup<NativeFunction<_c_TWSegwitAddressCreateWithString>>(
          'TWSegwitAddressCreateWithString');
  static late final _dart_TWSegwitAddressCreateWithString
  ...
  static late final _TWSegwitAddressCreateWithPublicKey_ptr =
      _lookup<NativeFunction<_c_TWSegwitAddressCreateWithPublicKey>>(
          'TWSegwitAddressCreateWithPublicKey');
  static late final _dart_TWSegwitAddressCreateWithPublicKey
  ...
  static late final _TWSegwitAddressDelete_ptr =
      _lookup<NativeFunction<_c_TWSegwitAddressDelete>>(
          'TWSegwitAddressDelete');
  static late final _dart_TWSegwitAddressDelete _TWSegwitAddressDelete =
  ...
  static late final _dart_TWSegwitAddressDescription
      _TWSegwitAddressDescription = _TWSegwitAddressDescription_ptr.asFunction<
  ...
  static late final _TWSegwitAddressHRP_ptr =
      _lookup<NativeFunction<_c_TWSegwitAddressHRP>>('TWSegwitAddressHRP');
  static late final _dart_TWSegwitAddressHRP _TWSegwitAddressHRP =
  ...
  static late final _TWSegwitAddressWitnessVersion_ptr =
      _lookup<NativeFunction<_c_TWSegwitAddressWitnessVersion>>(
          'TWSegwitAddressWitnessVersion');
  static late final _dart_TWSegwitAddressWitnessVersion
