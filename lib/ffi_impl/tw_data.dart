...
class TWData {
  ...
  static late final _TWDataCreateWithBytes_ptr =
      _lookup<NativeFunction<_c_TWDataCreateWithBytes>>(
          'TWDataCreateWithBytes');
  static late final _dart_TWDataCreateWithBytes _TWDataCreateWithBytes =
  ...
  late final _TWDataCreateWithSize_ptr =
      _lookup<NativeFunction<_c_TWDataCreateWithSize>>('TWDataCreateWithSize');
  ...
  static late final _TWDataCreateWithData_ptr =
      _lookup<NativeFunction<_c_TWDataCreateWithData>>('TWDataCreateWithData');
  static late final _dart_TWDataCreateWithData _TWDataCreateWithData =
  ...
  late final _TWDataCreateWithHexString_ptr =
      _lookup<NativeFunction<_c_TWDataCreateWithHexString>>(
  ...
  static late final _TWDataSize_ptr =
      _lookup<NativeFunction<_c_TWDataSize>>('TWDataSize');
  static late final _dart_TWDataSize _TWDataSize =
  ...
  static late final _TWDataBytes_ptr =
      _lookup<NativeFunction<_c_TWDataBytes>>('TWDataBytes');
  static late final _dart_TWDataBytes _TWDataBytes =
  ...
  late final _TWDataGet_ptr =
      _lookup<NativeFunction<_c_TWDataGet>>('TWDataGet');
  ...
  late final _TWDataSet_ptr =
      _lookup<NativeFunction<_c_TWDataSet>>('TWDataSet');
  ...
  late final _TWDataCopyBytes_ptr =
      _lookup<NativeFunction<_c_TWDataCopyBytes>>('TWDataCopyBytes');
  ...
  late final _TWDataReplaceBytes_ptr =
      _lookup<NativeFunction<_c_TWDataReplaceBytes>>('TWDataReplaceBytes');
  ...
  late final _TWDataAppendBytes_ptr =
      _lookup<NativeFunction<_c_TWDataAppendBytes>>('TWDataAppendBytes');
  ...
  late final _TWDataAppendByte_ptr =
      _lookup<NativeFunction<_c_TWDataAppendByte>>('TWDataAppendByte');
  ...
  late final _TWDataAppendData_ptr =
      _lookup<NativeFunction<_c_TWDataAppendData>>('TWDataAppendData');
  ...
  late final _TWDataReverse_ptr =
      _lookup<NativeFunction<_c_TWDataReverse>>('TWDataReverse');
  ...
  late final _TWDataReset_ptr =
      _lookup<NativeFunction<_c_TWDataReset>>('TWDataReset');
  ...
  static late final _TWDataDelete_ptr =
      _lookup<NativeFunction<_c_TWDataDelete>>('TWDataDelete');
  static late final _dart_TWDataDelete _TWDataDelete =
  ...
  late final _TWDataEqual_ptr =
      _lookup<NativeFunction<_c_TWDataEqual>>('TWDataEqual');
