...
abstract class TWPublicKey {
  ...
  static late final _TWPublicKeyCreateWithData_ptr =
      _lookup<NativeFunction<_c_TWPublicKeyCreateWithData>>(
          'TWPublicKeyCreateWithData');
  static late final _dart_TWPublicKeyCreateWithData _TWPublicKeyCreateWithData =
  ...
  static late final _TWPublicKeyDelete_ptr =
      _lookup<NativeFunction<_c_TWPublicKeyDelete>>('TWPublicKeyDelete');
  static late final _dart_TWPublicKeyDelete _TWPublicKeyDelete =
  ...
  static late final _TWPublicKeyIsCompressed_ptr =
      _lookup<NativeFunction<_c_TWPublicKeyIsCompressed>>(
          'TWPublicKeyIsCompressed');
  static late final _dart_TWPublicKeyIsCompressed _TWPublicKeyIsCompressed =
  ...
  static late final _TWPublicKeyCompressed_ptr =
      _lookup<NativeFunction<_c_TWPublicKeyCompressed>>(
          'TWPublicKeyCompressed');
  static late final _dart_TWPublicKeyCompressed _TWPublicKeyCompressed =
  ...
  static late final _TWPublicKeyUncompressed_ptr =
      _lookup<NativeFunction<_c_TWPublicKeyUncompressed>>(
          'TWPublicKeyUncompressed');
  static late final _dart_TWPublicKeyUncompressed _TWPublicKeyUncompressed =
  ...
  static late final _TWPublicKeyData_ptr =
      _lookup<NativeFunction<_c_TWPublicKeyData>>('TWPublicKeyData');
  static late final _dart_TWPublicKeyData _TWPublicKeyData =
  ...
  static late final _TWPublicKeyVerify_ptr =
      _lookup<NativeFunction<_c_TWPublicKeyVerify>>('TWPublicKeyVerify');
  static late final _dart_TWPublicKeyVerify _TWPublicKeyVerify =
  ...
  static late final _TWPublicKeyVerifyAsDER_ptr =
      _lookup<NativeFunction<_c_TWPublicKeyVerifyAsDER>>(
          'TWPublicKeyVerifyAsDER');
  static late final _dart_TWPublicKeyVerifyAsDER _TWPublicKeyVerifyAsDER =
  ...
  static late final _TWPublicKeyVerifyZilliqaSchnorr_ptr =
      _lookup<NativeFunction<_c_TWPublicKeyVerifyZilliqaSchnorr>>(
          'TWPublicKeyVerifyZilliqaSchnorr');
  static late final _dart_TWPublicKeyVerifyZilliqaSchnorr
  ...
  static late final _TWPublicKeyKeyType_ptr =
      _lookup<NativeFunction<_c_TWPublicKeyKeyType>>('TWPublicKeyKeyType');
  static late final _dart_TWPublicKeyKeyType _TWPublicKeyKeyType =
  ...
  static late final _TWPublicKeyDescription_ptr =
      _lookup<NativeFunction<_c_TWPublicKeyDescription>>(
          'TWPublicKeyDescription');
  static late final _dart_TWPublicKeyDescription _TWPublicKeyDescription =
  ...
  static late final _TWPublicKeyRecover_ptr =
      _lookup<NativeFunction<_c_TWPublicKeyRecover>>('TWPublicKeyRecover');
  static late final _dart_TWPublicKeyRecover _TWPublicKeyRecover =
