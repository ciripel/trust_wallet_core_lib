...
class TWDerivationPathIndex {
  ...
  static late final _TWDerivationPathIndexCreate_ptr =
      _lookup<NativeFunction<_c_TWDerivationPathIndexCreate>>(
          'TWDerivationPathIndexCreate');
  static late final _dart_TWDerivationPathIndexCreate
      _TWDerivationPathIndexCreate = _TWDerivationPathIndexCreate_ptr
          .asFunction<_dart_TWDerivationPathIndexCreate>();
  ...
  static late final _TWDerivationPathIndexDelete_ptr =
      _lookup<NativeFunction<_c_TWDerivationPathIndexDelete>>(
          'TWDerivationPathIndexDelete');
  static late final _dart_TWDerivationPathIndexDelete
      _TWDerivationPathIndexDelete = _TWDerivationPathIndexDelete_ptr
          .asFunction<_dart_TWDerivationPathIndexDelete>();
  ...
  static late final _TWDerivationPathIndexValue_ptr =
      _lookup<NativeFunction<_c_TWDerivationPathIndexValue>>(
          'TWDerivationPathIndexValue');
  static late final _dart_TWDerivationPathIndexValue
      _TWDerivationPathIndexValue = _TWDerivationPathIndexValue_ptr.asFunction<
  ...
  static late final _TWDerivationPathIndexHardened_ptr =
      _lookup<NativeFunction<_c_TWDerivationPathIndexHardened>>(
          'TWDerivationPathIndexHardened');
  static late final _dart_TWDerivationPathIndexHardened
  ...
  static late final _TWDerivationPathIndexDescription_ptr =
      _lookup<NativeFunction<_c_TWDerivationPathIndexDescription>>(
          'TWDerivationPathIndexDescription');
  static late final _dart_TWDerivationPathIndexDescription
