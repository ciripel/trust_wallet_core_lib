...
abstract class TWBitcoinAddress {
  ...
  static late final _TWBitcoinAddressEqual_ptr =
      _lookup<NativeFunction<_c_TWBitcoinAddressEqual>>(
          'TWBitcoinAddressEqual');
  static late final _dart_TWBitcoinAddressEqual _TWBitcoinAddressEqual =
  ...
  static late final _TWBitcoinAddressIsValid_ptr =
      _lookup<NativeFunction<_c_TWBitcoinAddressIsValid>>(
          'TWBitcoinAddressIsValid');
  static late final _dart_TWBitcoinAddressIsValid _TWBitcoinAddressIsValid =
  ...
  static late final _TWBitcoinAddressIsValidString_ptr =
      _lookup<NativeFunction<_c_TWBitcoinAddressIsValidString>>(
          'TWBitcoinAddressIsValidString');
  static late final _dart_TWBitcoinAddressIsValidString
  ...
  static late final _TWBitcoinAddressCreateWithString_ptr =
      _lookup<NativeFunction<_c_TWBitcoinAddressCreateWithString>>(
          'TWBitcoinAddressCreateWithString');
  static late final _dart_TWBitcoinAddressCreateWithString
  ...
  static late final _TWBitcoinAddressCreateWithData_ptr =
      _lookup<NativeFunction<_c_TWBitcoinAddressCreateWithData>>(
          'TWBitcoinAddressCreateWithData');
  static late final _dart_TWBitcoinAddressCreateWithData
  ...
  static late final _TWBitcoinAddressCreateWithPublicKey_ptr =
      _lookup<NativeFunction<_c_TWBitcoinAddressCreateWithPublicKey>>(
          'TWBitcoinAddressCreateWithPublicKey');
  static late final _dart_TWBitcoinAddressCreateWithPublicKey
  ...
  static late final _TWBitcoinAddressDelete_ptr =
      _lookup<NativeFunction<_c_TWBitcoinAddressDelete>>(
  ...
  static late final _TWBitcoinAddressDescription_ptr =
      _lookup<NativeFunction<_c_TWBitcoinAddressDescription>>(
          'TWBitcoinAddressDescription');
  static late final _dart_TWBitcoinAddressDescription
      _TWBitcoinAddressDescription = _TWBitcoinAddressDescription_ptr
  ...
  static late final _TWBitcoinAddressPrefix_ptr =
      _lookup<NativeFunction<_c_TWBitcoinAddressPrefix>>(
  ...
  static late final _TWBitcoinAddressKeyhash_ptr =
      _lookup<NativeFunction<_c_TWBitcoinAddressKeyhash>>(
          'TWBitcoinAddressKeyhash');
  static late final _dart_TWBitcoinAddressKeyhash _TWBitcoinAddressKeyhash =
