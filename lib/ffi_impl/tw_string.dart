...
class TWString {
  ...
  static late final _TWStringCreateWithUTF8Bytes_ptr =
      _lookup<NativeFunction<_c_TWStringCreateWithUTF8Bytes>>(
          'TWStringCreateWithUTF8Bytes');

  static late final _dart_TWStringCreateWithUTF8Bytes
  ...
  static late final _TWStringCreateWithRawBytes_ptr =
      _lookup<NativeFunction<_c_TWStringCreateWithRawBytes>>(
          'TWStringCreateWithRawBytes');
  static late final _dart_TWStringCreateWithRawBytes
      _TWStringCreateWithRawBytes = _TWStringCreateWithRawBytes_ptr.asFunction<
  ...
  static late final _TWStringCreateWithHexData_ptr =
      _lookup<NativeFunction<_c_TWStringCreateWithHexData>>(
          'TWStringCreateWithHexData');
  static late final _dart_TWStringCreateWithHexData _TWStringCreateWithHexData =
  ...
  static late final _TWStringSize_ptr =
      _lookup<NativeFunction<_c_TWStringSize>>('TWStringSize');
  static late final _dart_TWStringSize _TWStringSize =
  ...
  static late final _TWStringGet_ptr =
      _lookup<NativeFunction<_c_TWStringGet>>('TWStringGet');
  static late final _dart_TWStringGet _TWStringGet =
  ...
  static late final _TWStringUTF8Bytes_ptr =
      _lookup<NativeFunction<_c_TWStringUTF8Bytes>>('TWStringUTF8Bytes');
  ...
  static late final _TWStringDelete_ptr =
      _lookup<NativeFunction<_c_TWStringDelete>>('TWStringDelete');
  static late final _dart_TWStringDelete _TWStringDelete =
  ...
  static late final _TWStringEqual_ptr =
      _lookup<NativeFunction<_c_TWStringEqual>>('TWStringEqual');
  static late final _dart_TWStringEqual _TWStringEqual =
