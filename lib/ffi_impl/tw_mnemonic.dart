...
abstract class TWMnemonic {
  ...
  static late final _TWMnemonicIsValidWord_ptr =
      _lookup<NativeFunction<_c_TWMnemonicIsValidWord>>(
          'TWMnemonicIsValidWord');
  static late final _dart_TWMnemonicIsValidWord _TWMnemonicIsValidWord =
  ...
  static late final _TWMnemonicSuggest_ptr =
      _lookup<NativeFunction<_c_TWMnemonicSuggest>>('TWMnemonicSuggest');
  static late final _dart_TWMnemonicSuggest _TWMnemonicSuggest =
