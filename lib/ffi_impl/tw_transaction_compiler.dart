...
class TWTransactionCompiler {
  ...
  static late final _TWTransactionCompilerBuildInput_ptr =
      _lookup<NativeFunction<_c_TWTransactionCompilerBuildInput>>(
          'TWTransactionCompilerBuildInput');

  static late final _dart_TWTransactionCompilerBuildInput
  ...
  static late final _TWTransactionCompilerPreImageHashes_ptr =
      _lookup<NativeFunction<_c_TWTransactionCompilerPreImageHashes>>(
          'TWTransactionCompilerPreImageHashes');

  static late final _dart_TWTransactionCompilerPreImageHashes
  ...
  static late final _TWTransactionCompilerCompileWithSignatures_ptr =
      _lookup<NativeFunction<_c_TWTransactionCompilerCompileWithSignatures>>(
          'TWTransactionCompilerCompileWithSignatures');

  static late final _dart_TWTransactionCompilerCompileWithSignatures
