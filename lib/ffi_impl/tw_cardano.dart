...
class TWCardano {
  ...
  static late final _TWCardanoMinAdaAmount_ptr =
      _lookup<NativeFunction<_c_TWCardanoMinAdaAmount>>(
          'TWCardanoMinAdaAmount');
  static late final _dart_TWCardanoMinAdaAmount _TWCardanoMinAdaAmount =
  ...
  static late final _TWCardanoGetStakingAddress_ptr =
      _lookup<NativeFunction<_c_TWCardanoGetStakingAddress>>(
          'TWCardanoGetStakingAddress');
  static late final _dart_TWCardanoGetStakingAddress
      _TWCardanoGetStakingAddress = _TWCardanoGetStakingAddress_ptr.asFunction<
