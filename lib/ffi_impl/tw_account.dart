...
abstract class TWAccount {
  ...
  static late final _TWAccountCreate_ptr =
      _lookup<NativeFunction<_c_TWAccountCreate>>('TWAccountCreate');
  static late final _dart_TWAccountCreate _TWAccountCreate =
  ...
  static late final _TWAccountDelete_ptr =
      _lookup<NativeFunction<_c_TWAccountDelete>>('TWAccountDelete');
  static late final _dart_TWAccountDelete _TWAccountDelete =
  ...
  late final _TWAccountAddress_ptr =
      _lookup<NativeFunction<_c_TWAccountAddress>>('TWAccountAddress');
  ...
  late final _TWAccountDerivation_ptr =
      _lookup<NativeFunction<_c_TWAccountDerivation>>('TWAccountDerivation');
  ...
  late final _TWAccountDerivationPath_ptr =
      _lookup<NativeFunction<_c_TWAccountDerivationPath>>(
  ...
  late final _TWAccountPublicKey_ptr =
      _lookup<NativeFunction<_c_TWAccountPublicKey>>('TWAccountPublicKey');
  ...
  late final _TWAccountExtendedPublicKey_ptr =
      _lookup<NativeFunction<_c_TWAccountExtendedPublicKey>>(
  ...
  late final _TWAccountCoin_ptr =
      _lookup<NativeFunction<_c_TWAccountCoin>>('TWAccountCoin');
