...
abstract class TWGroestlcoinAddress {
  ...
  static late final _TWGroestlcoinAddressEqual_ptr =
      _lookup<NativeFunction<_c_TWGroestlcoinAddressEqual>>(
          'TWGroestlcoinAddressEqual');
  static late final _dart_TWGroestlcoinAddressEqual _TWGroestlcoinAddressEqual =
  ...
  static late final _TWGroestlcoinAddressIsValidString_ptr =
      _lookup<NativeFunction<_c_TWGroestlcoinAddressIsValidString>>(
          'TWGroestlcoinAddressIsValidString');
  static late final _dart_TWGroestlcoinAddressIsValidString
  ...
  static late final _TWGroestlcoinAddressCreateWithString_ptr =
      _lookup<NativeFunction<_c_TWGroestlcoinAddressCreateWithString>>(
          'TWGroestlcoinAddressCreateWithString');
  static late final _dart_TWGroestlcoinAddressCreateWithString
  ...
  static late final _TWGroestlcoinAddressCreateWithPublicKey_ptr =
      _lookup<NativeFunction<_c_TWGroestlcoinAddressCreateWithPublicKey>>(
          'TWGroestlcoinAddressCreateWithPublicKey');
  static late final _dart_TWGroestlcoinAddressCreateWithPublicKey
  ...
  static late final _TWGroestlcoinAddressDelete_ptr =
      _lookup<NativeFunction<_c_TWGroestlcoinAddressDelete>>(
          'TWGroestlcoinAddressDelete');
  static late final _dart_TWGroestlcoinAddressDelete
      _TWGroestlcoinAddressDelete = _TWGroestlcoinAddressDelete_ptr.asFunction<
  ...
  static late final _TWGroestlcoinAddressDescription_ptr =
      _lookup<NativeFunction<_c_TWGroestlcoinAddressDescription>>(
          'TWGroestlcoinAddressDescription');
  static late final _dart_TWGroestlcoinAddressDescription
