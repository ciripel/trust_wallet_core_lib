...
abstract class TWAES {
  ...
  static late final _TWAESEncryptCBC_ptr =
      _lookup<NativeFunction<_c_TWAESEncryptCBC>>('TWAESEncryptCBC');
  static late final _dart_TWAESEncryptCBC _TWAESEncryptCBC =
  ...
  static late final _TWAESDecryptCBC_ptr =
      _lookup<NativeFunction<_c_TWAESDecryptCBC>>('TWAESDecryptCBC');
  static late final _dart_TWAESDecryptCBC _TWAESDecryptCBC =
  ...
  static late final _TWAESEncryptCTR_ptr =
      _lookup<NativeFunction<_c_TWAESEncryptCTR>>('TWAESEncryptCTR');
  static late final _dart_TWAESEncryptCTR _TWAESEncryptCTR =
  ...
  static late final _TWAESDecryptCTR_ptr =
      _lookup<NativeFunction<_c_TWAESDecryptCTR>>('TWAESDecryptCTR');
  static late final _dart_TWAESDecryptCTR _TWAESDecryptCTR =
