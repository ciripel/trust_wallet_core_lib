...
class TWDataVector {
  ...
  static late final _TWDataVectorCreate_ptr =
      _lookup<NativeFunction<_c_TWDataVectorCreate>>('TWDataVectorCreate');
  static late final _dart_TWDataVectorCreate _TWDataVectorCreate =
  ...
  static late final _TWDataVectorCreateWithData_ptr =
      _lookup<NativeFunction<_c_TWDataVectorCreateWithData>>(
          'TWDataVectorCreateWithData');
  static late final _dart_TWDataVectorCreateWithData
      _TWDataVectorCreateWithData = _TWDataVectorCreateWithData_ptr.asFunction<
  ...
  static late final _TWDataVectorDelete_ptr =
      _lookup<NativeFunction<_c_TWDataVectorDelete>>('TWDataVectorDelete');
  static late final _dart_TWDataVectorDelete _TWDataVectorDelete =
  ...
  late final _TWDataVectorAdd_ptr =
      _lookup<NativeFunction<_c_TWDataVectorAdd>>('TWDataVectorAdd');
  ...
  static late final _TWDataVectorSize_ptr =
      _lookup<NativeFunction<_c_TWDataVectorSize>>('TWDataVectorSize');
  static late final _dart_TWDataVectorSize _TWDataVectorSize =
  ...
  late final _TWDataVectorGet_ptr =
      _lookup<NativeFunction<_c_TWDataVectorGet>>('TWDataVectorGet');
