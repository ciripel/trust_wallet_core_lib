...
abstract class TWEthereumAbi {
  ...
  static late final _TWEthereumAbiEncode_ptr =
      _lookup<NativeFunction<_c_TWEthereumAbiEncode>>('TWEthereumAbiEncode');
  static late final _dart_TWEthereumAbiEncode _TWEthereumAbiEncode =
  ...
  static late final _TWEthereumAbiDecodeOutput_ptr =
      _lookup<NativeFunction<_c_TWEthereumAbiDecodeOutput>>(
          'TWEthereumAbiDecodeOutput');
  static late final _dart_TWEthereumAbiDecodeOutput _TWEthereumAbiDecodeOutput =
  ...
  static late final _TWEthereumAbiDecodeCall_ptr =
      _lookup<NativeFunction<_c_TWEthereumAbiDecodeCall>>(
          'TWEthereumAbiDecodeCall');
  static late final _dart_TWEthereumAbiDecodeCall _TWEthereumAbiDecodeCall =
  ...
  static late final _TWEthereumAbiEncodeTyped_ptr =
      _lookup<NativeFunction<_c_TWEthereumAbiEncodeTyped>>(
          'TWEthereumAbiEncodeTyped');
  static late final _dart_TWEthereumAbiEncodeTyped _TWEthereumAbiEncodeTyped =
