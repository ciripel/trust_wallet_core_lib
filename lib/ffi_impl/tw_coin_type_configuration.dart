...
abstract class TWCoinTypeConfiguration {
  ...
  static late final _TWCoinTypeConfigurationGetSymbol_ptr =
      _lookup<NativeFunction<_c_TWCoinTypeConfigurationGetSymbol>>(
          'TWCoinTypeConfigurationGetSymbol');
  static late final _dart_TWCoinTypeConfigurationGetSymbol
  ...
  static late final _TWCoinTypeConfigurationGetDecimals_ptr =
      _lookup<NativeFunction<_c_TWCoinTypeConfigurationGetDecimals>>(
          'TWCoinTypeConfigurationGetDecimals');
  static late final _dart_TWCoinTypeConfigurationGetDecimals
  ...
  static late final _TWCoinTypeConfigurationGetTransactionURL_ptr =
      _lookup<NativeFunction<_c_TWCoinTypeConfigurationGetTransactionURL>>(
          'TWCoinTypeConfigurationGetTransactionURL');
  static late final _dart_TWCoinTypeConfigurationGetTransactionURL
  ...
  static late final _TWCoinTypeConfigurationGetAccountURL_ptr =
      _lookup<NativeFunction<_c_TWCoinTypeConfigurationGetAccountURL>>(
          'TWCoinTypeConfigurationGetAccountURL');
  static late final _dart_TWCoinTypeConfigurationGetAccountURL
  ...
  static late final _TWCoinTypeConfigurationGetID_ptr =
      _lookup<NativeFunction<_c_TWCoinTypeConfigurationGetID>>(
          'TWCoinTypeConfigurationGetID');
  static late final _dart_TWCoinTypeConfigurationGetID
  ...
  static late final _TWCoinTypeConfigurationGetName_ptr =
      _lookup<NativeFunction<_c_TWCoinTypeConfigurationGetName>>(
          'TWCoinTypeConfigurationGetName');
  static late final _dart_TWCoinTypeConfigurationGetName
